...
const DataViewAll = () => {
  ...
  const getColorICA = (valor) => {
    if (!valor && valor !== 0) return "bg-gray-300 text-black"
      ...
      <div className="container mx-auto px-4">
        <div className="w-full max-w-6xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6">
            ...
            {/* Buscador */}
            <div className="flex flex-col md:flex-row md:items-end gap-3 sm:gap-4 mb-4 sm:mb-6">
              {searchMode === "single" ? (
                <div className="flex-1">
                  ...
                  <input
                    ...
                    className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#7eb53c] focus:border-transparent text-sm"
                  />
                </div>
              ) : (
                <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#4c8cb4] focus:border-transparent text-sm"
                    />
                  </div>
                  <div>
                    <label
              ...
              <div className="flex gap-2">
                <button
                  ...
                  } text-white py-2 px-3 sm:px-4 rounded-md font-medium transition-colors flex items-center gap-1 sm:gap-2 disabled:opacity-50 text-xs sm:text-sm`}
                  disabled={isLoading}
                >
                ...
                {searchPerformed && (
                  <button
                    ...
                    className="bg-gray-200 hover:bg-gray-300 text-gray-700 py-2 px-3 sm:px-4 rounded-md font-medium transition-colors flex items-center gap-1 sm:gap-2 text-xs sm:text-sm"
                  >
